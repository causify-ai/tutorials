...
- You can model your working setup (TODO Krishna: Fill the details after confirmation)

## Pre-requisites

- Watch, star, and fork the Sorrentum repo (TODO Krishna: Correct this based on the input)
...
- You will submit two markdown files (TODO Krishna: Confirm it with GP)
  ...
  * `XYZ.example.md`:  A markdown with a full example of an application     using the API
  ...
  - Each markdown file should cover:
    - What it is the package
    - What problem it solves
    - What are the alternatives, both open source and commercial with
      comments about advantages and disadvantages 
    - Describe the native API
    - Description of the Docker container
    - Visual aids with mermaid (e.g., flow diagrams, data transformation
      steps, and plots) to enhance understanding
    - References to books and in-depth tutorial that we have run and we think
      are awesome
...
- Projects from 2024 (TODO Krishna: Confirm if its still relevant)
