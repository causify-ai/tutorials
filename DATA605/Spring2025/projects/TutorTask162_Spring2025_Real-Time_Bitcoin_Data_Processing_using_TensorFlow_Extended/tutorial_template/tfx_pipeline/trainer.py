...
#     def extract_features_and_labels(features):
#         transformed_features = {
#             key: features[key] 
#             for key in features 
#             if key != LABEL_KEY
#         }
#         return transformed_features, features[LABEL_KEY]
    
#     return dataset.map(extract_features_and_labels)

# def _build_model():
#     """Builds and returns a simple LSTM model."""
