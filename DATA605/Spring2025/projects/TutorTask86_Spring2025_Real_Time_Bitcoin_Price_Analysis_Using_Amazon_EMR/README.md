...
This project demonstrates how to ingest, process, and analyze real-time Bitcoin price data using Amazon EMR with Apache Spark.
...
## 📁 Project Structure
DATA605/Spring2025/projects/TutorTask86_Spring2025_Real_Time_Bitcoin_Price_Analysis_Using_Amazon_EMR/ ├── bitcoin_ingest.API.py
...
## 🚀 Next Steps
- Finalize cluster execution
- Integrate automation using EMR steps
