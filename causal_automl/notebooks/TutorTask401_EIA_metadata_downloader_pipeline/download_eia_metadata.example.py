...
eiu.plot_distribution(df_metadata, column="frequency_id", title="Distribution of Frequencies")

# Units distribution plot.
eiu.plot_distribution(df_metadata, column="data_units", title="Distribution of Data Units")

# Number of time serires per dataset plot.
eiu.plot_distribution(df_metadata, column="dataset_id", title="Number of Time Series per Dataset")
