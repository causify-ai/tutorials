...
DIR_TAG="tutorial_tensorflow"

# NOTE: We can't use $0 to find out in which file we are in, since this file is
# sourced and not executed.
SCRIPT_PATH="tutorial_tensorflow/dev_scripts_${DIR_TAG}/thin_client/setenv.sh"
...
DEV_SCRIPT_DIR="${GIT_ROOT_DIR}/tutorial_tensorflow/dev_scripts_${DIR_TAG}"
